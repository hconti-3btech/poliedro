        ...
        <div class="col-12">
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('pessoas.store')}}" onsubmit="bloqSubmit()"  enctype="multipart/form-data">
                            @csrf      
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="ra" type="text" class="form-control" placeholder="Registro do Aluno" name="ra">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
